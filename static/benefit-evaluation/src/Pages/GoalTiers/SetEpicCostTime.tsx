...
export const SetEpicCostTime = (props: EpicCostTimeProps) => {
    ...
    const submit = async () => {
        ...
        await api.issue
            .setIssueCostTime(updatedValues)
            .then(() => {
                setSubmitting(false)
                onClose(true)
            })
                        ...
                        {!isLoading ? (
                            <>
                                <Inline space="space.050">
                                    ...
                                    And these values will all be normalized to a
                                    total of 100 cost points.
                                </Inline>
                                <Inline space="space.050">
                                    The time is the expected relative time to
                                    complete each epic. This is a relative
                                    value, so not in hours or days.
                                </Inline>
                                <Inline space="space.050">
                                    {'Total costs:'}
